...
if __name__ == '__main__':
    ...
    obs_size = env.observation_space.shape[0] #TODO: Set observation size space 4
    n_actions = env.action_space.n #TODO: Set action size space 2
    ...
    for iter_no, batch in enumerate(iterate_batches(env, net, BATCH_SIZE)):
        ...
        obs_v, acts_v, reward_b, reward_m = filter_batch(batch, 70) #TODO identify the episode in top PERCENTILE
